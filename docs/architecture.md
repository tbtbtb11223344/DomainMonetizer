...
The admin exposes an evidence status, not an automatic expansion command. Complete rollup coverage, an unsampled distinct-session query, and fresh exact-release readiness for every published pilot tenant are hard prerequisites:
