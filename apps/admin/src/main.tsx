...
function App() {
  ...
  return <div className="shell">
    ...
    <main className="workspace" id="portfolio">
      ...
      {overview?.sampling.detected && <div className="error" role="alert"><span>Exactness</span>Analytics sampling reached ×{overview.sampling.maxSampleInterval}. Qualified-session counts are not exact, so scale review is blocked.</div>}
